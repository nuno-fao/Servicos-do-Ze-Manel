        ...
        if(cin>>opt && opt<=5)
        {
            ...
            case 1:{
                for (unsigned i = 0; i < Company::getCompany()->getStatCong().size(); i++) {
                    cout << ":::::::::::::::::::" << endl;
                    cout << "Month/Year: " << (Company::getCompany()->getStatCong()[i].first % 12+1) <<"/"<<int(Company::getCompany()->getStatCong()[i].first/12)  << endl;
            ...
            case 3:{
                for (unsigned i = 0; i < Company::getCompany()->getStatHaz().size(); i++) {
                    cout << ":::::::::::::::::::" << endl;
                    cout << "Month/Year: " << (Company::getCompany()->getStatHaz()[i].first % 12+1) << "/" << int(Company::getCompany()->getStatHaz()[i].first / 12) << endl;
            ...
            case 4:{
                for (unsigned i = 0; i < Company::getCompany()->getStatNorm().size(); i++) {
                    cout << ":::::::::::::::::::" << endl;
                    cout << "Month/Year: " << (Company::getCompany()->getStatNorm()[i].first % 12+1) << "/" << int(Company::getCompany()->getStatNorm()[i].first / 12) << endl;
            ...
            case 5:{
                for (unsigned i = 0; i < Company::getCompany()->getStatAnim().size(); i++) {
                    cout << ":::::::::::::::::::" << endl;
                    cout << "Month/Year: " << (Company::getCompany()->getStatAnim()[i].first % 12+1) << "/" << int(Company::getCompany()->getStatAnim()[i].first / 12) << endl;
